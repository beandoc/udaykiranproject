...
export const quizData: { [lang: string]: QuizDataByLang } = {
    ...
    hi: {
        ...
        'evaluation-process': [
            ...
            { question: "एचआईवी या हेपेटाइटिस जैसे संक्रमणों के लिए स्क्रीनिंग का मुख्य कारण क्या है?", options: [ "आपके रक्त प्रकार का निर्धारण करने के लिए", "उन संक्रमणों की पहचान करने के लिए जो प्रत्यारोपण के बाद जटिलताओं का कारण बन सकते हैं", "आपके कोलेस्ट्रॉल के स्तर की जांच के लिए", "एक सरकारी आवश्यकता को पूरा करने के लिए" ], correctAnswer: "उन संक्रमणों की पहचान करने के लिए जो प्रत्यारोपण के बाद जटिलताओं का कारण बन सकते हैं", explanation: "रक्त परीक्षणों का उपयोग एचआईवी या हेपेटाइटिस जैसे अंतर्निहित संक्रमणों के लिए स्क्रीन करने के लिए किया जाता है जो सर्जरी के बाद गंभीर जटिलताओं का कारण बन सकते हैं जब आप इम्यूनोसप्रेसेंट दवाओं पर होते हैं।" },
